...
# GIT REPO
LUNAREP="https://raw.githubusercontent.com/ProVPN-Xhach/ProVPN/main/"

function ADD_CEEF() {
EMAILCF="dm.napoli10@gmail.com"
KEYCF="213f142bc6f2e4a8f9060566a97a7bce2518d"
...
PW_DEFAULT() {
    ...
    local password_url="https://raw.githubusercontent.com/ProVPN-Xhach/ProVPN/main/configure/password"
...
LIMIT_HANDLER() {
    ...
    wget https://raw.githubusercontent.com/ProVPN-Xhach/ProVPN/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh
...
MENU_SETUP() {
    ...
    wget https://raw.githubusercontent.com/ProVPN-Xhach/ProVPN/main/feature/LUNAVPN
    unzip LUNAVPN
    chmod +x menu/*
...
BOT_SHELL() {
   ...
   wget https://raw.githubusercontent.com/ProVPN-Xhach/ProVPN/main/LTbotVPN/SHELLBOT
    unzip SHELLBOT
    mv LTBOTVPN /usr/bin
